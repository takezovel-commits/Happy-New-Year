...
Tertanda: Kaionn Niko`
  ...
  xylan: {
    img: "img/xylan.png",
    text: `Happy New Year Xylan.
Terimakasih sudah mau menjadi salah satu teman gw, selalu support gw dan tetap bertahan dari zaman gw ilang arah.
Terimakasih juga udah jadi tempat curhatan dan udah percaya sama gw ya Lan.

Jangan bosen-bosen sama gw hahaha.
Btw cari yang seagama jir jangan beda server mulu.
...
document.getElementById("envelope").onclick = () => {
  ...
  if (data[key]) {
    ...
    pesan.innerText =
      "Nama lu belum terdaftar bro 😅\n\nTapi tetap, semoga 2026 jadi tahun yang lebih baik buat lu.";
